...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+psycopg://yeongyangkkuk:yeongyangkkuk-local@localhost:5432/yeongyangkkuk_dev"

    mail_host: str = "localhost"
    mail_port: int = Field(default=1025, ge=1, le=65535)
    mail_from_address: str = "no-reply@yeongyangkkuk.local"
