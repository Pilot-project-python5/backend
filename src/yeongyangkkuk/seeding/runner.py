...
from yeongyangkkuk.care.nutrient_reference_seeds import NutrientReferenceSeedSet
from yeongyangkkuk.curation.expert_comment_seeds import ExpertCommentSeedSet
...
from yeongyangkkuk.medication.seeds import MedicationSeedSet
